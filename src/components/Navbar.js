...
const Navbar = () => {
  ...
  const styleLink =
    "mb-8 mx-8 lg:mb-0 lg:mx-0 transition-all duration-500 ease-out hover:text-blue-global lg:hover:text-gray-dark lg:hover:shadow-[inset_0px_-6px_0px] lg:hover:shadow-blue-light";
  ...
  const activeStyle = {
    color: "#292929",
    boxShadow: "inset 0 -7px 0 #007fff",
          ...
          <li>
            ...
            >
              <FontAwesomeIcon
                ...
                className="pb-1 text-[1.2rem] text-gray-dark transition-all duration-[400ms] ease-out hover:text-blue-global"
              />
            </a>
          </li>
