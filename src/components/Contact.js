      ...
      <div className="lg:flex lg:gap-20 ">
        <form className="mb-10 mt-14 lg:w-3/5" onSubmit={handleSubmit}>
          ...
          <motion.button
            ...
            viewport={{ once: true }}
            type="submit"
            className="block pl-[2px] text-[0.940rem] font-medium uppercase leading-[0.875rem] tracking-widest shadow-[inset_0px_-6px_0px] shadow-blue-light transition-all duration-[400ms] ease-out hover:shadow-[inset_0px_-15px_0px] hover:shadow-blue-light lg:text-[0.85rem]"
          >
            {isSubmitting ? (
              <>
                En cours...
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <p className="break-all text-sm text-blue-global transition-colors duration-500 group-hover:text-blue-light">
                  stevi.enoto@gmail.com
                </p>
              </div>
            </a>
          </motion.div>
