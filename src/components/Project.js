    ...
    >
      ...
      {projectsToShow < allProjects.length && (
        <motion.button
          ...
          className="group m-auto mt-16 block rounded border-2 border-solid border-transparent bg-blue-light px-3 py-2 text-sm font-medium uppercase tracking-wider text-off-white hover:border-blue-light hover:bg-gray-dark hover:text-blue-light md:px-4 transition-all duration-300 ease-in-out"
