...
const Skills = () => {
  const animationProject = {
    ...
    animate: (id) => ({
      y: 0,
      opacity: 1,
      transition: { duration: 0.3, delay: 0.15 * id },
    }),
  };
  ...
  return (
    ...
    >
      ...
      <div className="m-auto flex max-w-[850px] flex-col items-center gap-6 md:flex-row lg:gap-8">
        ...
        <div className="flex w-full flex-row-reverse items-center justify-around gap-5 md:block md:w-[30%] lg:w-[30%]">
          <motion.ul
            ...
            viewport={{ once: true }}
          >
            <li className="mb-1 text-off-white">▸ API REST (Django/DRF)</li>
            <li className="mb-1 text-off-white">▸ Auth JWT / sécurité</li>
            <li className="mb-1 text-off-white">▸ Tests & qualité</li>
            <li className="mb-1 text-off-white">▸ Docker / CI</li>
          </motion.ul>
          ...
          <motion.ul
            ...
            viewport={{ once: true }}
          >
            <li className="mb-1 text-off-white">▸ Autonomie</li>
            <li className="mb-1 text-off-white">▸ Rigueur</li>
            <li className="mb-1 text-off-white">▸ Communication</li>
            <li className="mb-1 text-off-white">▸ Esprit produit</li>
          </motion.ul>
        </div>
      </div>
    </section>
