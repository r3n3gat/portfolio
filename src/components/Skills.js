      ...
      <div className="md:m- m-auto flex max-w-[850px] flex-col items-center gap-6 md:flex-row lg:gap-8">
        ...
        <div className="flex w-full flex-row-reverse items-center justify-around gap-5 md:block md:w-[30%] lg:w-[30%]">
          <motion.ul
            ...
            viewport={{ once: true }}
          >
            <li className="mb-1 md:mb-0 text-off-white">▸ GreenCode</li>
            <li className="mb-1 md:mb-0 text-off-white">▸ Référencement SEO</li>
            <li className="mb-1 md:mb-0 text-off-white">▸ Méthode agile</li>
            <li className="mb-1  md:mb-0 text-off-white">▸ Accessibilité</li>
          </motion.ul>
          ...
          <motion.ul
            ...
            viewport={{ once: true }}
          >
            <li className="mb-1 md:mb-0 text-off-white">▸ Autonomie</li>
            <li className="mb-1 md:mb-0 text-off-white">▸ Flexibilité</li>
            <li className="mb-1 md:mb-0 text-off-white">▸ Perséverance</li>
            <li className="mb-1 md:mb-0 text-off-white">▸ Rigueur</li>
          </motion.ul>
        </div>
      </div>
    </section>
