  ...
  return (
    <section className="mb-5 mt-20 flex flex-col items-center justify-center gap-6 bg-gray-global bg-bg-black bg-cover bg-fixed bg-center px-4 py-8 text-off-white brightness-[1.5] md:mt-24 md:p-10 lg:mt-[120px] lg:gap-9 lg:p-20">
      <motion.p
        ...
        viewport={{ once: true }}
      >
        Découvrez mon profil complet en{" "}
      ...
      >
        <a
          ...
          className="group rounded border-2 border-solid border-transparent bg-blue-global px-3 py-2 text-sm font-sm uppercase tracking-wider text-off-white transition-all duration-300 ease-in hover:border-blue-global hover:bg-black hover:text-blue-global md:px-4 md:text-base"
        >
          Voir mon CV (PDF){" "}
          <FontAwesomeIcon
            icon={faCircleChevronRight}
            className="ml-1 mt-1 translate-x-0 transition-all duration-300 ease-in group-hover:translate-x-1 md:mt-0"
          />
        </a>
